...
namespace OscCore
{
    ...
    public class OscActionPair
    {
        ...
        /// </summary>
        public readonly OSCAction ValueRead;
        ...
        public OscActionPair(OSCAction valueRead, Action mainThreadQueued = null)
        {
        ...
        public delegate void OSCAction(OscMessageValues values, string addr);
    }
}